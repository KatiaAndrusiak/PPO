...
*/
   ...
   std::cout << "\n****** Koło ratunkowe *****\n";
   std::string cmpX="compareX", cmpY="compareY", cmpXY="compareXY";
   std::cout<<"X="<<compareX(poznan,krakow)<<" Y="<<compareY(poznan,krakow)<<" XY="<<compareXY(poznan,krakow)<<std::endl;
   directions(poznan,krakow,cmpX);
   directions(poznan,krakow,cmpY);
   directions(poznan,krakow,cmpXY);
   std::cout<<"X="<<compareX(tarnow,krakow)<<" Y="<<compareY(tarnow,krakow)<<" XY="<<compareXY(tarnow,krakow)<<std::endl;
   directions(tarnow,krakow,cmpX);
   directions(tarnow,krakow,cmpY);
   directions(tarnow,krakow,cmpXY);
   std::cout<<"X="<<compareX(poznan,nyc)<<" Y="<<compareY(poznan,nyc)<<" XY="<<compareXY(poznan,nyc)<<std::endl;
   directions(poznan,nyc,cmpX);
   directions(poznan,nyc,cmpY);
   directions(poznan,nyc,cmpXY);
   std::cout<<"X="<<compareX(nyc,krakow)<<" Y="<<compareY(nyc,krakow)<<" XY="<<compareXY(nyc,krakow)<<std::endl;
   directions(nyc,krakow, cmpX);
   directions(nyc,krakow, cmpY);
   directions(nyc,krakow, cmpXY);
   std::cout<<"X="<<compareX(krakow,zielonki)<<" Y="<<compareY(krakow,zielonki)<<" XY="<<compareXY(krakow,zielonki)<<std::endl;
   directions(krakow,zielonki,cmpX);
   directions(krakow,zielonki,cmpY);
   directions(krakow,zielonki,cmpXY);

   std::cout<<"X="<<compareX(krakow,batorska)<<" Y="<<compareY(krakow,batorska)<<" XY="<<compareXY(krakow,batorska)<<std::endl;
